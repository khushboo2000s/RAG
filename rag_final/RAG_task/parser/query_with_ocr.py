...
AZURE_SEARCH_ENDPOINT = os.getenv('AZURE_SEARCH_ENDPOINT', 'https://your-search-endpoint.search.windows.net')
...
client = AzureOpenAI(
    azure_endpoint=os.getenv("OPENAI_API_BASE", "https://your-openai-endpoint.azure.com/"),
...
def perform_search(user_question):
    ...
    if answer:
        source_link = f"Source: [Open Document ID: 2022ESG Report.pdf](file:///D:/Genai_project/Retrieval%20Augmented%20Generation/rag_final/RAG_task/data_files/2022ESG%20Report.pdf)"
        return answer + f"\n\n{source_link}"  # Append the clickable link
    else:
        return "Sorry, I couldn't find an answer for your question."

# Test the function with a sample query
if __name__ == "__main__":
    user_question = "What are the key findings from the 2022 ESG report?"
    result = perform_search(user_question)
